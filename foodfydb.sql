-- ATENTION : 
--Run block by block, separately

-- If the foodfy database already exists,
-- delete it by executing just this command.
DROP DATABASE foodfy;

-- If you want to clean the database to populate
-- the database from scratch, run these blocks.
...
-- To create the bank, just execute this command.
CREATE DATABASE foodfy;

--After creating the database, the tables are created,
-- the blocks starting with CREATE TABLE,
-- can be executed all together.
